...
<template>
  <div class="sunrise-sunset-arc flex flex-col items-center">
    ...
    <div class="relative w-full max-w-[200px] aspect-[2/1]">
      <svg viewBox="0 0 180 100" class="w-full h-full">
        ...
        <g :transform="`translate(${sunPos.x - 8}, ${sunPos.y - 8})`" class="transition-all duration-1000">
          <circle cx="8" cy="8" r="10" :fill="isDaylight ? 'var(--accent)' : 'var(--text-muted)'" opacity="0.2" />
